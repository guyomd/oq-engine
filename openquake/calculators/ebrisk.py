...
def ebrisk(rupgetters, srcfilter, param, monitor):
    ...
    with monitor('getting ruptures'):
        for rupgetter in rupgetters:
            ...
            if gg.computers:
                [comp] = gg.computers
                comp.num_assets = rupgetter.num_assets
    ...
    for c in computers:
        ...
        hazard['gmf_info'].append(
            (c.rupture.ridx, mon_haz.task_no, len(c.sids), c.num_assets,
